...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"id" : "obj-77",
					"items" : [ "None", ",", "BlackHole 64ch", ",", "Haut-parleurs MacBook Pro", ",", "Flux:: Aggregate Device", ",", "Microsoft Teams Audio", ",", "ZoomAudioDevice" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"id" : "obj-76",
					"items" : [ "None", ",", "BlackHole 64ch", ",", "Microphone MacBook Pro", ",", "Flux:: Aggregate Device", ",", "Microsoft Teams Audio", ",", "ZoomAudioDevice" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
